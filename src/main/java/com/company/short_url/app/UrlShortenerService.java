...
public class UrlShortenerService {
    ...
    public UrlShortenerService(Map<String, String> urlMap, Random rnd, DataManager dataManager, OptionCache optionCache) {
        this.rnd = rnd;
    ...
    private boolean cndidatePathUnique(String cndidatePath) {
        List<ShortUrl> shortUrl = dataManager.load(ShortUrl.class).query("e.shortUrl = ?1", cndidatePath).list();
